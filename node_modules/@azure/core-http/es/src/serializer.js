    ...
    for (var i = 0; i < object.length; i++) {
        ...
        if (isXml && elementType.xmlNamespace) {
            ...
            if (elementType.type.name === "Composite") {
                tempArray[i] = __assign(__assign({}, serializedValue), { $: (_a = {}, _a[xmlnsKey] = elementType.xmlNamespace, _a) });
            }
            else {
            ...
            if (parentObject != undefined) {
                if (isXml && mapper.xmlNamespace) {
                    var xmlnsKey = mapper.xmlNamespacePrefix
                        ...
                        : "xmlns";
                    parentObject.$ = __assign(__assign({}, parentObject.$), (_a = {}, _a[xmlnsKey] = mapper.xmlNamespace, _a));
                }
...
function getXmlObjectValue(propertyMapper, serializedValue, isXml) {
    ...
    if (["Composite"].includes(propertyMapper.type.name)) {
        return __assign({ $: xmlNamespace }, serializedValue);
    }
